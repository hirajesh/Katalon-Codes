...
System.out.println("Verify Schedule 2 Store Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '2', FailureHandling.STOP_ON_FAILURE)
