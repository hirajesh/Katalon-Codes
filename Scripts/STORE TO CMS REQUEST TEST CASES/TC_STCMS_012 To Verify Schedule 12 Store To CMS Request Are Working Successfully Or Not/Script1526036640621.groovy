...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '12', FailureHandling.STOP_ON_FAILURE)
...
for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '12', 
...
System.out.println("Schedule 12 STORE Request Are Working Successfully")
