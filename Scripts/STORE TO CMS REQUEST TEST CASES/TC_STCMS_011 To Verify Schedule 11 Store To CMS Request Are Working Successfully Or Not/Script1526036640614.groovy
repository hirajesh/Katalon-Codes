...
System.out.println("Verify Schedule 11 STORE Request Are Working Successfully Or Not")
...
WebUI.waitForElementVisible(findTestObject('Store Request Schedule 1/Page_Store/a_CMS'),20)
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '11', FailureHandling.STOP_ON_FAILURE)
...
for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '11', 
