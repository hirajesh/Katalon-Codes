...
System.out.println("Verify Schedule 6 STORE Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '6', FailureHandling.STOP_ON_FAILURE)
...
System.out.println ("Size of the medicine" +SelectedOptions.toString())

for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '6', 
...
System.out.println("Schedule 6 STORE Request Are Working Successfully")
