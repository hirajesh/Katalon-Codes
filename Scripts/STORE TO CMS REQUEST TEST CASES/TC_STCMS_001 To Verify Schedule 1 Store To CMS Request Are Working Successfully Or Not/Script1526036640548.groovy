...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Store Request Schedule 1/Page_Divisonal Store Login/button_Sign in'),20)
