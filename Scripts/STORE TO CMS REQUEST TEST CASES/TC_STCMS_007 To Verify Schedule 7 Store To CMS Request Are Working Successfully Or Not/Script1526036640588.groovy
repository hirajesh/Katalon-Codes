...
System.out.println("Verify Schedule 7 STORE Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '7', FailureHandling.STOP_ON_FAILURE)

TestObject medicine=new TestObject()

medicine=WebUI.modifyObjectProperty(medicine, 'xpath', "equals", "//*[@id='optmedicine']", true)

WebUI.verifyElementPresent(medicine, 20)
...
for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '7', 
...
System.out.println("Schedule 7 STORE Request Are Working Successfully")
