...
System.out.println("Verify Schedule 10 STORE Request Are Working Successfully Or Not")
...
WebUI.setText(findTestObject('Store Request Schedule 1/Page_Divisonal Store Login/input_txtusername'), 'brsnavas')

WebUI.setText(findTestObject('Store Request Schedule 1/Page_Divisonal Store Login/input_txtpassword'), 'navas123')
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '10', FailureHandling.STOP_ON_FAILURE)
...
System.out.println ("Total Numberof Size="+SelectedOptions.toString())

for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '10', 
 ...
 //   WebUI.delay(1)
    ...
    WebUI.setText(findTestObject('Store Request Schedule 1/Page_Store/input_txttreat'), '1000')
...
WebUI.waitForElementVisible(findTestObject('Store Request Schedule 1/Page_Store/a_dropdown-toggle'),20)
...
WebUI.setText(findTestObject('Store Request Schedule 1/Page_CMO login/input_txtusername'), 'brsjana')

WebUI.setText(findTestObject('Store Request Schedule 1/Page_CMO login/input_txtpassword'), 'jana123')
...
WebUI.setText(findTestObject('store Request Schedule 1/Page_CMS login/input_txtusername'), 'vino2')
...
for (int row = 0; row <SelectedOptions - 1; row++) {
    /*
...
WebUI.waitForElementVisible(findTestObject('store Request Schedule 1/Page_KDMC - CMS/button_OK'),20)
...
System.out.println("Schedule 10 STORE Request Are Working Successfully")
