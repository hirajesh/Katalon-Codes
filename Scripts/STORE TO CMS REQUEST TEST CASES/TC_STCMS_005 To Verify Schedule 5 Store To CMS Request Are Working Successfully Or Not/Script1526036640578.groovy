...
System.out.println("Verify Schedule 5 STORE Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '5', FailureHandling.STOP_ON_FAILURE)
...
for (int y = 1; y <SelectedOptions  ; y++) {
    WebUI.selectOptionByIndex(findTestObject('Store Request Schedule 1/Page_Store/select_--Select--Schedule 1Inj'), '5', 
...
System.out.println("Schedule 5 STORE Request Are Working Successfully")
