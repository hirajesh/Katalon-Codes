...
System.out.println("Verify Schedule 5 Inpatient Request Are Working Successfully Or Not")
...
WebUI.setText(findTestObject('Inpatient Request/Page_INPATIENT LOGIN/input_txtusername'), 'brsvishnu')

WebUI.setText(findTestObject('Inpatient Request/Page_INPATIENT LOGIN/input_txtpassword'), 'vishnu123')
...
WebUI.delay(3)
//WebUI.navigateToUrl('http://182.18.161.229/Multihospital_New/StoresRequest.aspx')

WebUI.navigateToUrl('http://122.165.236.133/Multihospital/StoresRequest.aspx')
...
WebUI.selectOptionByIndex(findTestObject('Inpatient Request/Page_KDMC/select_--Select--ChildrensGene'), '1', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('Inpatient Request/Page_KDMC/select_--Select--Schedule 5Dru'), '1', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Inpatient Request/Page_CMO login/input_txtusername'), 'brsjana')

WebUI.setText(findTestObject('Inpatient Request/Page_CMO login/input_txtpassword'), 'jana123')
...
WebUI.setText(findTestObject('Inpatient Request/Page_Divisonal Store Login/input_txtusername'), 'brsnavas')

WebUI.setText(findTestObject('Inpatient Request/Page_Divisonal Store Login/input_txtpassword'), 'navas123')
...
System.out.println("Schedule 5 Inpatient Request Are Working Successfully")