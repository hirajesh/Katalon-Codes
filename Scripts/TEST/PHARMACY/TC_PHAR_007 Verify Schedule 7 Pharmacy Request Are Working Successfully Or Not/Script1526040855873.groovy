...
System.out.println("Verify Schedule 7 Pharmacy Request Are Working Successfully Or Not")

WebUI.navigateToUrl('http://792.168.137.1/multihospital_new/')
...
WebUI.selectOptionByIndex(findTestObject('PharmacyRequest/Page_KDMC-Pharmacy/select_--Select--Schedule 1Inj'), '7', FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Schedule 7 Pharmacy Request Are Working Successfully")
