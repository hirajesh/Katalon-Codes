...
System.out.println("Verify Schedule 5 Pharmacy Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('PharmacyRequest/Page_KDMC-Pharmacy/select_--Select--Schedule 1Inj'), '5', FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Schedule 5 Pharmacy Request Are Working Successfully")
