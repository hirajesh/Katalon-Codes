...
WebUI.doubleClick(findTestObject('HealthpostToStore/Page_HealthPost Store/a_Request to Store'))

WebUI.doubleClick(findTestObject('HealthpostToStore/Page_HealthPost Store/a_Medicine Request'))

WebUI.selectOptionByIndex(findTestObject('HealthpostToStore/Page_HealthPost Store/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)
...
for (int e = 1; e <= (5 - 1); e++) {
    ...
    WebUI.doubleClick(findTestObject('HealthpostToStore/Page_HealthPost Store/button_Add'))
}
