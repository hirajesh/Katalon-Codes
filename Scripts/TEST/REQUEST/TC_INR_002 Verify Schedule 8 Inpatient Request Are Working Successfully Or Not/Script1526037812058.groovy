...
System.out.println("Verify Schedule 8 Inpatient Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Inpatient Request/Page_KDMC/select_--Select--ChildrensGene'), '2', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('Inpatient Request/Page_KDMC/select_--Select--Schedule 5Dru'), '2', FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Schedule 8 Inpatient Request Are Working Successfully")