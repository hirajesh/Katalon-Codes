...
System.out.println("Verify Schedule 5 Emergency  Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Schedule 1Inj'), '3', FailureHandling.STOP_ON_FAILURE)

seletedoptions = WebUI.getNumberOfTotalOption(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Adernaline 0.'))

System.out.println(seletedoptions)
...
System.out.println("Schedule 5 Emergency Request Are Working Successfully")
