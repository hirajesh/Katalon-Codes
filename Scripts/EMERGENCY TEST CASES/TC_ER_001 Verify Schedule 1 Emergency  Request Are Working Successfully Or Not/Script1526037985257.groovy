...
System.out.println("Verify Schedule 1 Emergency  Request Are Working Successfully Or Not")

//WebUI.navigateToUrl('http://192.168.137.1/Multihospital_New/EmergencyLogin.aspx')

WebUI.navigateToUrl('http://122.165.236.133/Multihospital/EmergencyLogin.aspx')

WebUI.maximizeWindow()

WebUI.setText(findTestObject('Emergency/Page_Emergency login/input_txtusername'), 'brsrana')

WebUI.setText(findTestObject('Emergency/Page_Emergency login/input_txtpassword'), 'rana123')
...
WebUI.selectOptionByIndex(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

seletedoptions = WebUI.getNumberOfTotalOption(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Adernaline 0.'))

for (int u = 1; u <seletedoptions; u++) {
    WebUI.selectOptionByIndex(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.setText(findTestObject('Emergency/Page_KDMC - Emergency/input_txttreat'), '10')
...
WebUI.setText(findTestObject('Emergency/Page_CMO login/input_txtusername'), 'brsjana')

WebUI.setText(findTestObject('Emergency/Page_CMO login/input_txtpassword'), 'jana123')
...
WebUI.setText(findTestObject('Emergency/Page_Divisonal Store Login/input_txtusername'), 'brsnavas')

WebUI.setText(findTestObject('Emergency/Page_Divisonal Store Login/input_txtpassword'), 'navas123')
...
try
{
	  ...
	  {
		  WebUI.delay(1)
		    WebUI.setText(findTestObject('Emergency/Page_Store/input_txtqty'), '10')
...
System.out.println("Schedule 1 Emergency Request Are Working Successfully")
