...
System.out.println("Verify Schedule 8 Emergency  Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Schedule 1Inj'), '5', FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Schedule 8 Emergency Request Are Working Successfully")
