...
System.out.println("Verify Schedule 9 Emergency  Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('Emergency/Page_KDMC - Emergency/select_--Select--Schedule 1Inj'), '6', FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Emergency/Page_KDMC - Emergency/font_ERNO100520183'),20)
...
System.out.println("Schedule 9 Emergency Request Are Working Successfully")
