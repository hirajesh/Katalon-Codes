...
System.out.println(" Verify Schedule 5 Investigation Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('lab/Page_KDMC/select_--Select--Schedule 4X-r'), '2', FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Schedule 5 Investigation Request Are Working Successfully")
