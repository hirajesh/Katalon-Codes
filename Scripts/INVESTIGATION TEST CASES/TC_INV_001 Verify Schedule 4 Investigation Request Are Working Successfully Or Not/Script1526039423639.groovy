...
System.out.println(" Verify Schedule 4 Investigation Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('lab/Page_KDMC/select_--Select--Schedule 4X-r'), '1', FailureHandling.STOP_ON_FAILURE)
...
for(int a=1;a<selectedoptions;a++)
{
...
System.out.println("Schedule 4 Investigation Request Are Working Successfully")
