...
System.out.println(" Verify Schedule 10 Investigation Request Are Working Successfully Or Not")

WebUI.maximizeWindow()

WebUI.click(findTestObject('lab/Page_KDMC/a_Investigation'))

WebUI.setText(findTestObject('lab/Page_Investigation login/input_txtusername'), 'manoj')

WebUI.setText(findTestObject('lab/Page_Investigation login/input_txtpassword'), '123')
...
WebUI.selectOptionByIndex(findTestObject('lab/Page_KDMC/select_--Select--Schedule 4X-r'), '5', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('lab/Page_KDMC/input_txttreat'), '10')
...
WebUI.setText(findTestObject('lab/Page_CMO login/input_txtusername'), 'guru')

WebUI.setText(findTestObject('lab/Page_CMO login/input_txtpassword'), '123')
...
WebUI.setText(findTestObject('lab/Page_Divisonal Store Login/input_txtusername'), 'ragu')

WebUI.setText(findTestObject('lab/Page_Divisonal Store Login/input_txtpassword'), '123')
...
try 
{
	  ...
	  {
		  WebUI.setText(findTestObject('lab/Page_Store/input_txtqty'), '10')
...
System.out.println("Schedule 10 Investigation Request Are Working Successfully")
