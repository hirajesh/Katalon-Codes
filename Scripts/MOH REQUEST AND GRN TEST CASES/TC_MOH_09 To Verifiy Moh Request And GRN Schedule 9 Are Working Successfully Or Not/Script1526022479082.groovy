...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '9', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC/select_--Select--Hamen Chandra'), '12', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--PO0032PO0031P'),PONumber1, true)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '19500')

WebUI.delay(1)

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_2'), '650')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'IA' + RandomInt(1, 10, 999))
