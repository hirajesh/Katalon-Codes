...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '8', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC/select_--Select--Hamen Chandra'), '10', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '14000')

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_2'), '400')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'HA' + RandomInt(1, 10, 999))
