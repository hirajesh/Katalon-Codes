...
WebUI.setText(findTestObject('MOH AND GRN/Page_CMS login/input_txtusername'), 'vino2')
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '4', FailureHandling.STOP_ON_FAILURE)
...
for (int j = 1; j <=selectedoptions-1; j++) {
    ...
    WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txttreat'), '50000')
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC/select_--Select--Hamen Chandra'), '2', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_CMS login/input_txtusername'), 'brsjana')

WebUI.setText(findTestObject('MOH AND GRN/Page_CMS login/input_txtpassword'), 'jana123')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '1700')

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_2'), '560')

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_3'), 'DH' + RandomInt(3, 10, 999))
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtqty'), '50000')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'DA' + RandomInt(1, 10, 999))
