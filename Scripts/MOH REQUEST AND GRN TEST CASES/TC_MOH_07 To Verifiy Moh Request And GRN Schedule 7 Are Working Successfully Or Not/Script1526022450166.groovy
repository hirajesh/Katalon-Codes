...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '7', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '20000')

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_2'), '900')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'GA' + RandomInt(1, 10, 999))
