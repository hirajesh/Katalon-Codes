...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '10', FailureHandling.STOP_ON_FAILURE)
...
TestObject RequestNumberId = WebUI.modifyObjectProperty(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_PO0032'), 'xpath', 
    'equals', ('//*[@id =' + RequestNUmber) + ']', true)
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC/select_--Select--Hamen Chandra'), '5', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '10000')
...
for (int t = 1; t < GrnLength; t++) {
    ...
    WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'JA' + RandomInt(1, 10, 999))
