...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '12', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC/select_--Select--Hamen Chandra'), '1', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '17000')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'LA' + RandomInt(1, 10, 999))
