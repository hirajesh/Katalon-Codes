...
WebUI.selectOptionByIndex(findTestObject('MOH AND GRN/Page_KDMC - CMS/select_--Select--Schedule 1Inj'), '11', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_1'), '16500')

WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtgrnno_2'), '250')
...
WebUI.setText(findTestObject('MOH AND GRN/Page_KDMC - CMS/input_txtbatchno'), 'KA' + RandomInt(1, 10, 999))
