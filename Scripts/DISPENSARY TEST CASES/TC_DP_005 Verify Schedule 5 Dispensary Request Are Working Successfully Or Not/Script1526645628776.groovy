...
WebUI.selectOptionByIndex(findTestObject('DispensaryToStore/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '5', FailureHandling.STOP_ON_FAILURE)
