...
WebUI.selectOptionByIndex(findTestObject('DispensaryToCms/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '10',
	FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('DispensaryToCms/Page_KDMC - CMS/a_dropdown-toggle'),20)
