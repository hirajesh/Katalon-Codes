...
WebUI.waitForElementPresent(findTestObject('DispensaryToCms/Page_Dispensary Store/a_CMS'),20)
...
WebUI.selectOptionByIndex(findTestObject('DispensaryToCms/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '3',
	FailureHandling.STOP_ON_FAILURE)
