...
WebUI.selectOptionByIndex(findTestObject('DispensaryToCms/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '1',
	FailureHandling.STOP_ON_FAILURE)
...
System.out.println("Rqty : "+Rqty)*/
	...
	for (int n = 1; n <= (batchsize - 1); n++) {
		...
		if (Integer.valueOf(batchqty) >= Integer.valueOf(Rqty)) {
			...
			System.out.println('Batch qty Is Less Than Rqty')
		}
	}
}
