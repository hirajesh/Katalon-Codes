...
WebUI.selectOptionByIndex(findTestObject('DispensaryToCms/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '6',
	FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('DispensaryToCms/Page_Dispensary Store/a_dropdown-toggle'),20)
