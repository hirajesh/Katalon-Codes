...
WebUI.doubleClick(findTestObject('DispensaryToStore/Page_Dispensary Store/a_Request to Store'))

WebUI.doubleClick(findTestObject('DispensaryToStore/Page_Dispensary Store/a_Medicine Request'))

WebUI.selectOptionByIndex(findTestObject('DispensaryToStore/Page_Dispensary Store/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)
...
for (int e = 1; e <= (medicineslength - 1); e++) {
    ...
    WebUI.doubleClick(findTestObject('DispensaryToStore/Page_Dispensary Store/button_Add'))
...
WebUI.waitForElementPresent(findTestObject('DispensaryToStore/Page_Dispensary Store/a_dropdown-toggle'),20)
...
WebUI.waitForElementPresent(findTestObject('DispensaryToStore/Page_Store/a_dropdown-toggle'),20)
