...
WebUI.selectOptionByIndex(findTestObject('HealthpostToCms/Page_HealthPost Store/select_--Select--Schedule 1Inj'), '3',
	FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('HealthpostToCms/Page_KDMC - CMO/a_dropdown-toggle'),20)
