...
WebUI.selectOptionByIndex(findTestObject('HealthpostToCms/Page_HealthPost Store/select_--Select--Schedule 1Inj'), '12',
	FailureHandling.STOP_ON_FAILURE)
...
//WebUI.waitForImagePresent(findTestObject('HealthpostToCms/Page_HealthPost Store/a_dropdown-toggle'),20)
...
//WebUI.waitForImagePresent(findTestObject('HealthpostToCms/Page_KDMC - CMO/a_dropdown-toggle'),20)
...
//WebUI.waitForImagePresent(findTestObject('HealthpostToCms/Page_KDMC - CMS/a_dropdown-toggle'),20)
