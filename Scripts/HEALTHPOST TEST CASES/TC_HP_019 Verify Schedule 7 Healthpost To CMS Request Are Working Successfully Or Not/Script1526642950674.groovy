...
WebUI.selectOptionByIndex(findTestObject('HealthpostToCms/Page_HealthPost Store/select_--Select--Schedule 1Inj'), '7',
	FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('HealthpostToCms/Page_HealthPost Store/font_PRNO18052018174'),20)
...
WebUI.waitForElementVisible(findTestObject('HealthpostToCms/Page_KDMC - CMS/button_OK'),20)
