...
System.out.println("Verify Schedule 2 Pharmacy Request Are Working Successfully Or Not")
...
WebUI.setText(findTestObject('PharmacyRequest/Page_Pharmacy login/input_txtusername'), 'brsshafi')

WebUI.setText(findTestObject('PharmacyRequest/Page_Pharmacy login/input_txtpassword'), 'shafi123')
...
WebUI.selectOptionByIndex(findTestObject('PharmacyRequest/Page_KDMC-Pharmacy/select_--Select--Schedule 1Inj'), '2', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('PharmacyRequest/Page_KDMC-Pharmacy/input_txttreat'), '100')
...
TestObject clickok=new TestObject()
WebUI.modifyObjectProperty(clickok, "xpath", "equals", "/html/body/div[5]/div/div/div[2]/button", true)
...
WebUI.setText(findTestObject('PharmacyRequest/Page_CMO login/input_txtusername'), 'brsjana')

WebUI.setText(findTestObject('PharmacyRequest/Page_CMO login/input_txtpassword'), 'jana123')
...
WebUI.setText(findTestObject('PharmacyRequest/Page_Divisonal Store Login/input_txtusername'), 'brsnavas')

WebUI.setText(findTestObject('PharmacyRequest/Page_Divisonal Store Login/input_txtpassword'), 'navas123')
...
{
	WebUI.setText(findTestObject('PharmacyRequest/Page_Store/input_txtqty'), '100')
...
System.out.println("Schedule 2 Pharmacy Request Are Working Successfully")
