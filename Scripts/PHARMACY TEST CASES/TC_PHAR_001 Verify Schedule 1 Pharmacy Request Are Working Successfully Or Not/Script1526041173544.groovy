...
System.out.println("Verify Schedule 1 Pharmacy Request Are Working Successfully Or Not")
...
WebUI.selectOptionByIndex(findTestObject('PharmacyRequest/Page_KDMC-Pharmacy/select_--Select--Schedule 1Inj'), '1', FailureHandling.STOP_ON_FAILURE)
...
{
	System.out.println(" "+StockQty+">="+RequestedQty)
	WebUI.delay(1)
...
System.out.println("Schedule 1 Pharmacy Request Are Working Successfully")
